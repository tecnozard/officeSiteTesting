             ...
             <ul>
              ...
              <li class="dropdown"><a ><span>IT SERVICES</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                <ul>
                  ...
                  <li><a href="/internshipdetails">Internship Training</a></li>
              ...
              <li class="dropdown" class="active"><a ><span>NON-IT SERVICES</span> <i class="bi bi-chevron-down toggle-dropdown"></i></a>
                <ul>
