    ...
    <div class="email-container">
        ...
        <ul>
            @if($internship->resume)
                <li><a href="{{ asset('storage/' . $internship->resume) }}" target="_blank">Resume</a></li>
            @endif
            @if($internship->payment_proof)
                <li><a href="{{ asset('storage/' . $internship->payment_proof) }}" target="_blank">Payment Proof</a></li>
            @endif
            @if($internship->id_proof)
                <li><a href="{{ asset('storage/' . $internship->id_proof) }}" target="_blank">ID Proof</a></li>
            @endif
        </ul>
