...
app.controller('InternshipController', function ($scope, $http, $timeout) {
  ...
  $scope.submitInternshipForm = function () {
    if ($scope.internshipForm.$valid) {
      ...
      var formatDateToDMY = function formatDateToDMY(date) {
        if (!date) return '';
        var d = new Date(date);
      ...
      var resumeFile = (_document$getElementB = document.getElementById('resume')) === null || _document$getElementB === void 0 ? void 0 : _document$getElementB.files[0];
      var paymentProofFile = (_document$getElementB2 = document.getElementById('paymentProof')) === null || _document$getElementB2 === void 0 ? void 0 : _document$getElementB2.files[0];
      var id_proofFile = (_document$getElementB3 = document.getElementById('idProof')) === null || _document$getElementB3 === void 0 ? void 0 : _document$getElementB3.files[0];
...
app.controller("LoginController", function ($scope, $http) {
  ...
  $scope.login = function () {
    ...
    $scope.errorMessage = "";
    $http.post("/api/admin/login", $scope.admin).then(function (response) {
...
document.addEventListener("DOMContentLoaded", function () {
  ...
  var isServicePage = false; // Flag to check if any service page is active
...
app.controller("TypingTestController", function ($scope, $http, $interval) {
  ...
  $scope.checkWord = function () {
    var typedWords = $scope.typedText.trim().split(" ");
    var correct = 0;
    var total = typedWords.length;
    var generatedWordsArray = $scope.currentWords.split(" ");
  ...
  $scope.endTest = function () {
    ...
    if ($scope.wordCount >= 30 && $scope.accuracy >= 85) {
      ...
      $scope.closePopup = function () {
        $scope.testCompleted = false; // Hide popup when clicking "OK"
      };
    } else {
  ...
  function saveToDatabase(isSelected) {
    ...
    $http.post("/api/save-typing-test", data).then(function (response) {
...
document.addEventListener("keydown", function (event) {
  if (event.key === "F12" || event.ctrlKey && event.shiftKey && event.key === "I" || event.ctrlKey && event.shiftKey && event.key === "J" || event.ctrlKey && event.key === "U" || event.ctrlKey && event.key === "S" || event.ctrlKey && event.shiftKey && event.key === "C") {
    event.preventDefault();
  }
});
